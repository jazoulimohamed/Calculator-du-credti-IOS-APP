...
@interface NotaryFeesView4Controller ()
...
@implementation NotaryFeesView4Controller
...
- (void)initializeComponents {
    ...
    self.slider1.minimumValue = 200000.0;
    self.slider1.maximumValue = 500000.0;
    self.slider1.value = 300000.0;
    ...
    self.slider2.minimumValue = 20000.0;
    self.slider2.maximumValue = 200000.0;
